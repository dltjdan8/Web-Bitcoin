...
public interface ApiService {
	...
	public String[] getStatus(String order_currency)
			throws JsonMappingException, IllegalArgumentException, JsonProcessingException;

	public Map<String, Object> getBtci() throws JsonMappingException, IllegalArgumentException, JsonProcessingException;
